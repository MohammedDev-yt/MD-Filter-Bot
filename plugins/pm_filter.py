...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('Tʜᴇᴛᴇʀ Print')
            else:
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Uᴘᴅᴀᴛᴇs', url='https://t.me/Aero_Unity')
            ],[
            InlineKeyboardButton('ℹ️ Hᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('👩‍💻 Rᴇᴘᴏ', url='https://Github.Com/MohammedDev-yt/MD-Filter-Bot'),
        ...
        await query.answer('Theater's Print)
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("Ckeck The Correct Spelling")
        await asyncio.sleep(8)
        await k.delete()
        return
